  ...
  describe(`#teams`, () => {
    ...
    describe(`#get()`, () => {
      it(`retrieves a specific team`, () => spark.teams.create({
        ...
        .then((team) => {
          assert.isTeam(team);
          return assert.becomes(spark.teams.get({id: team.id}), team);
        }));
    });
      ...
      describe(`when the user leaves the team's general room`, () => {
        ...
        it(`no longer returns the team's rooms`, () => spark.teams.create({
          ...
          .then((teamRooms) => {
            ...
            return spark.memberships.list({roomId: generalRoom.id, personId: spark.$user.id});
          })
          .then((memberships) => {
            return spark.memberships.remove(memberships.items[0]);
          })
          .then(() => {
